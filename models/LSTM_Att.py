...
## TODO: Implement a bi-directional LSTM encoder with an LSTM decoder with attention here as our "best" model
## FOr now just do it with 1 layer, try to replicate what we did in A4 for Chr->Eng
...
class LSTM_Att(NMT): # TODO: INHERT FROM NMT
    """
